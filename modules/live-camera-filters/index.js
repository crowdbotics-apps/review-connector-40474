...
import { View, TouchableOpacity, Text, PermissionsAndroid, Platform, Alert } from "react-native"; // @ts-ignore

import CameraRoll from "@react-native-community/cameraroll";
import Icon from "react-native-vector-icons/MaterialCommunityIcons"; // @ts-ignore
  ...
  return <View style={styles.cameraContainer}>
      ...
      <View style={styles.filterContainer}>
        ...
        <View style={styles.cameraUIView}>
          <TouchableOpacity style={styles.menuButton} onPress={switchCameraDirection}>
            <Text style={_styles.RBwlyvgQ}>{switchCamera ? <Icon name="camera-rear-variant" size={25} color="#fff" /> : <Icon name="camera-front-variant" size={25} color="#fff" />}</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuButton} onPress={handleTakePicture}>
            <Text style={_styles.wbMfWeqS}><Icon name="camera-iris" size={50} color="#fff" /></Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuButton} onPress={switchFlashLight}>
            <Text style={_styles.FGzWrJDp}>{switchFlash ? <Icon name="flash" size={25} color="#fff" /> : <Icon name="flash-off" size={25} color="#fff" />}</Text>
          </TouchableOpacity>
        </View>
