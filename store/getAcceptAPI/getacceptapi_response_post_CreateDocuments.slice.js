...
export const getacceptapi_post_v1_documents_create = createAsyncThunk("getacceptapi_response_post_CreateDocuments/getacceptapi_post_v1_documents_create", async payload => {
  const response = await apiService.getacceptapi_post_v1_documents_create(payload);
