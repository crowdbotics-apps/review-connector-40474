...
export const getacceptapi_get_v1_documents_list = createAsyncThunk("getacceptapi_response_get_GetDocuments/getacceptapi_get_v1_documents_list", async payload => {
  const response = await apiService.getacceptapi_get_v1_documents_list(payload);
