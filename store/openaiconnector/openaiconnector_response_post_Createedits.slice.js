...
export const openaiconnector_post_v1_edits_create = createAsyncThunk(
  "openaiconnector_response_post_Createedits/openaiconnector_post_v1_edits_create",
  async payload => {
    const response = await apiService.openaiconnector_post_v1_edits_create(
      payload
    )
