...
export const openaiconnector_post_v1_completions_create = createAsyncThunk("openaiconnector_response_post_Createcompletions/openaiconnector_post_v1_completions_create", async payload => {
  const response = await apiService.openaiconnector_post_v1_completions_create(payload);
