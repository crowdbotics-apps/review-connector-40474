...
export const openaiconnector_get_v1_models_model_read = createAsyncThunk("openaiconnector_response_get_Retrievemodels/openaiconnector_get_v1_models_model_read", async payload => {
  const response = await apiService.openaiconnector_get_v1_models_model_read(payload);
