...
export const cesium3dmap_delete_assets_assets_id_delete = createAsyncThunk("cesium3dmap_response_delete_DeleteAssets/cesium3dmap_delete_assets_assets_id_delete", async payload => {
  const response = await apiService.cesium3dmap_delete_assets_assets_id_delete(payload);
