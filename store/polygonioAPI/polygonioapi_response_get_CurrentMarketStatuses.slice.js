...
export const polygonioapi_get_v1_marketstatus_now_list = createAsyncThunk("polygonioapi_response_get_CurrentMarketStatuses/polygonioapi_get_v1_marketstatus_now_list", async payload => {
  const response = await apiService.polygonioapi_get_v1_marketstatus_now_list(payload);
